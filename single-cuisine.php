...
while(have_posts()){
    ...
    <p><a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('cuisine'); ?>"><i class="fa fa-home" aria-hidden="true"></i> All Cuisines</a> <span class="metabox__main"><?php the_title(); ?> </span></p>
        </div> 
